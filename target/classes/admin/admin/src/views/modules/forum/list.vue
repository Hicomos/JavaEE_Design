            ...
            <el-table :data="forumData" height="250">
                ...
                <el-table-column label="身份">
                    <template slot-scope="scope">
                        <span v-if="scope.row.jiequyonghuId">
                            接取用户
                        </span>
                        <span v-if="scope.row.fabuyonghuId">
                            发布用户
                        </span>
                ...
                <el-table-column property="caozuo" label="操作">
                    <template slot-scope="scope">
                        <el-button type="info"                          @click="seeForumContent(scope.row.forumContent)">回帖详情</el-button>
                            <el-button v-if="true &&( false|| (sessionTable == 'jiequyonghu' && scope.row.jiequyonghuId ==userId)
|| (sessionTable == 'fabuyonghu' && scope.row.fabuyonghuId ==userId)
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/task/upload/forumMuBan.xls"
                        >批量导入论坛数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('forum','导入导出')"
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        data.data.list.forEach(el=>{
                            ...
                            forum.jiequyonghuId = el.jiequyonghuId;//---
                            forum.jiequyonghuName = el.jiequyonghuName;
                            forum.jiequyonghuPhone = el.jiequyonghuPhone;
                            forum.jiequyonghuIdNumber = el.jiequyonghuIdNumber;
                            forum.jiequyonghuPhoto = el.jiequyonghuPhoto;
                            forum.newMoney = el.newMoney;
                            forum.wanchenglv = el.wanchenglv;
                            forum.jiequyonghuEmail = el.jiequyonghuEmail;
                            forum.createTime = el.createTime;
                            forum.fabuyonghuId = el.fabuyonghuId;//---
                            forum.fabuyonghuName = el.fabuyonghuName;
                            forum.fabuyonghuPhone = el.fabuyonghuPhone;
                            forum.fabuyonghuIdNumber = el.fabuyonghuIdNumber;
                            forum.fabuyonghuPhoto = el.fabuyonghuPhoto;
                            forum.newMoney = el.newMoney;
                            forum.fabuyonghuEmail = el.fabuyonghuEmail;
                            forum.createTime = el.createTime;
