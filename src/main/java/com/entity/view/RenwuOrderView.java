...
public class RenwuOrderView extends RenwuOrderEntity implements Serializable {
	...
	*/
	...
	private String renwuOrderValue;
	...
	public RenwuOrderView() {

	}

	public RenwuOrderView(RenwuOrderEntity renwuOrderEntity) {
		try {
			BeanUtils.copyProperties(this, renwuOrderEntity);
	...
	* 获取： 订单类型的值
	*/
	public String getRenwuOrderValue() {
		return renwuOrderValue;
	}
	/**
	* 设置： 订单类型的值
	*/
	public void setRenwuOrderValue(String renwuOrderValue) {
		this.renwuOrderValue = renwuOrderValue;
	}
	...
	public String toString() {
		return "RenwuOrderView{" +
			", renwuOrderValue=" + renwuOrderValue +
			", renwuName=" + renwuName +
