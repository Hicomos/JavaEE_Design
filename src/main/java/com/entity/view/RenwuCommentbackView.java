...
public class RenwuCommentbackView extends RenwuCommentbackEntity implements Serializable {
	...
	public RenwuCommentbackView() {

	}

	public RenwuCommentbackView(RenwuCommentbackEntity renwuCommentbackEntity) {
		try {
			BeanUtils.copyProperties(this, renwuCommentbackEntity);
